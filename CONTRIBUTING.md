# Contributing to `attackmap-analyzer-node-service`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-node-service.git
cd attackmap-analyzer-node-service
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-node-service/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-node-service/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-node-service`, you agree that your contributions will be
